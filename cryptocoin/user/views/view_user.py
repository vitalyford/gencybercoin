...
def secret(request):
    if request.user.is_authenticated:
        ...
        # bug bounty
        run_bug_bounty(request, ud, 'bug#1:sensitive_data_exposure', 'Congrats! You found a secret page that programmers sometimes forget about. This kind of bug may expose sensitive data.', 'https://www.owasp.org/index.php/Top_10-2017_A3-Sensitive_Data_Exposure')
        # end bug bounty
